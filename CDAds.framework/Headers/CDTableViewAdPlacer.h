...
@protocol CDTableViewAdPlacerDelegate;

////////////////////////////////////////////////////////////////////////////////////////////////////

/**
 * The `CDTableViewAdPlacer` class allows you to request native ads from the CDAds ad server and
...
@interface CDTableViewAdPlacer : NSObject

@property (nonatomic, weak) id<CDTableViewAdPlacerDelegate> delegate;
 ...
 * be configured dynamically on the CDAds website.
 *
 * When you make an ad request, the ad placer will ask the CDAds ad server for the positions where
 * ads should be inserted into the table view. You can configure these positioning values by
 * editing your ad unit's settings on the CDAds website.
 *
 * Using this method is equivalent to calling
 * +placerWithTableView:viewController:adPositioning:rendererConfigurations: and passing in an
 * `CDServerAdPositioning` object as the `positioning` parameter.
 *
 ...
 * the native ad is rendered. You should pass in cdAdInfos that can render any ad type that
 * may be displayed for the given ad unit.
 *
 * @return An `CDTableViewAdPlacer` object.
 */
 ...
 *
 * First, you may pass an `CDServerAdPositioning` object as the `positioning` parameter, which tells
 * the ad placer to obtain positioning information dynamically from the ad server, which you can
 * configure on the CDAds website. In many cases, this is the preferred approach, since it allows
 ...
 * this as well.
 *
 * Alternatively, if you wish to hard-code your positions, you may pass an `CDClientAdPositioning`
 * object instead.
 *
 * @param tableView The table view in which to insert ads.
 * @param controller The view controller which should be used to present modal content.
 ...
 * @return An `CDTableViewAdPlacer` object.
 */
+ (instancetype)placerWithTableView:(UITableView *)tableView viewController:(UIViewController *)controller adPositioning:(CDAdPositioning *)positioning rendererConfigurations:(NSArray *)rendererConfigurations;

/** @name Requesting Ads */

/**
 * Requests ads from the CDAds ad server using the specified ad unit ID.
 *
 * @param adUnitID A string representing a CDAds ad unit ID.
 */
- (void)loadAdsForAdUnitID:(NSString *)adUnitID;

/**
 * Requests ads from the CDAds ad server using the specified ad unit ID and targeting parameters.
 *
 * @param adUnitID A string representing a CDAds ad unit ID.
 * @param targeting An object containing targeting information, such as geolocation data.
 */
- (void)loadAdsForAdUnitID:(NSString *)adUnitID targeting:(CDNativeAdRequestTargeting *)targeting;
...
/**
 * The CDAds SDK adds interfaces to the `UITableView` class to help your application with
 * responsibilities related to `CDTableViewAdPlacer`. These APIs include methods to help notify the
...
@interface UITableView (CDTableViewAdPlacer)

- (void)cd_setAdPlacer:(CDTableViewAdPlacer *)placer;
 ...
 */
- (CDTableViewAdPlacer *)cd_adPlacer;
 ...
 */
- (void)cd_setDataSource:(id<UITableViewDataSource>)dataSource;
 ...
 */
- (id<UITableViewDataSource>)cd_dataSource;
 ...
 */
- (void)cd_setDelegate:(id<UITableViewDelegate>)delegate;
 ...
 */
- (id<UITableViewDelegate>)cd_delegate;
 ...
 */
- (void)cd_insertRowsAtIndexPaths:(NSArray *)indexPaths withRowAnimation:(UITableViewRowAnimation)animation;
 ...
 */
- (void)cd_deleteRowsAtIndexPaths:(NSArray *)indexPaths withRowAnimation:(UITableViewRowAnimation)animation;
 ...
 */
- (void)cd_reloadRowsAtIndexPaths:(NSArray *)indexPaths withRowAnimation:(UITableViewRowAnimation)animation;
 ...
 * *indexPath*.
 */
- (void)cd_moveRowAtIndexPath:(NSIndexPath *)indexPath toIndexPath:(NSIndexPath *)newIndexPath;
 ...
 * @param animation A constant that indicates how the reloading is to be animated.
 */
- (void)cd_reloadSections:(NSIndexSet *)sections withRowAnimation:(UITableViewRowAnimation)animation;
 ...
 * to make room for it.
 */
- (void)cd_moveSection:(NSInteger)section toSection:(NSInteger)newSection;
 ...
 */
- (UITableViewCell *)cd_cellForRowAtIndexPath:(NSIndexPath *)indexPath;
 ...
 */
- (id)cd_dequeueReusableCellWithIdentifier:(NSString *)identifier forIndexPath:(NSIndexPath *)indexPath;
 ...
 * immediate.
 */
- (void)cd_deselectRowAtIndexPath:(NSIndexPath *)indexPath animated:(BOOL)animated;
 ...
 */
- (NSIndexPath *)cd_indexPathForCell:(UITableViewCell *)cell;
 ...
 */
- (NSIndexPath *)cd_indexPathForRowAtPoint:(CGPoint)point;
 ...
 */
- (NSIndexPath *)cd_indexPathForSelectedRow;
 ...
 */
- (NSArray *)cd_indexPathsForRowsInRect:(CGRect)rect;
 ...
 */
- (NSArray *)cd_indexPathsForSelectedRows;
 ...
 */
- (NSArray *)cd_indexPathsForVisibleRows;
 ...
 */
- (CGRect)cd_rectForRowAtIndexPath:(NSIndexPath *)indexPath;
 ...
 * immediate.
 */
- (void)cd_scrollToRowAtIndexPath:(NSIndexPath *)indexPath atScrollPosition:(UITableViewScrollPosition)scrollPosition animated:(BOOL)animated;
 ...
 */
- (void)cd_selectRowAtIndexPath:(NSIndexPath *)indexPath animated:(BOOL)animated scrollPosition:(UITableViewScrollPosition)scrollPosition;
 ...
 */
- (NSArray *)cd_visibleCells;

@end

@protocol CDTableViewAdPlacerDelegate <NSObject>
 ...
 */
-(void)nativeAdWillPresentModalForTableViewAdPlacer:(CDTableViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdDidDismissModalForTableViewAdPlacer:(CDTableViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdWillLeaveApplicationFromTableViewAdPlacer:(CDTableViewAdPlacer *)placer;
