...
@class CDNativeAdRenderingImageLoader;

/**
 * The CDNativeAdRendering protocol provides methods for displaying ad content in
 * custom view classes.
 *
...
@protocol CDNativeAdRendering <NSObject>
 ...
 */
- (void)layoutCustomAssetsWithProperties:(NSDictionary *)customProperties imageLoader:(CDNativeAdRenderingImageLoader *)imageLoader;
