...
/**
 * The `CDClientAdPositioning` class is a model that allows you to control the positions where
 * native cdertisements should appear within a stream. A positioning object works in conjunction
 ...
 *
 * Unlike with `CDServerAdPositioning`, which tells an ad placer to obtain its positioning
 * information from the CDAds ad server, client ad positioning does not allow you to control your ad
 * positions via the CDAds website.
 */

@interface CDClientAdPositioning : CDAdPositioning
