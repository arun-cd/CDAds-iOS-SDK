...
@protocol CDCollectionViewAdPlacerDelegate;

////////////////////////////////////////////////////////////////////////////////////////////////////

/**
 * The `CDCollectionViewAdPlacer` class allows you to request native ads from the CDAds ad server
...
@interface CDCollectionViewAdPlacer : NSObject

@property (nonatomic, weak) id<CDCollectionViewAdPlacerDelegate> delegate;
 ...
 *
 * @return An `CDCollectionViewAdPlacer` object.
 */
 ...
 * @return An `CDCollectionViewAdPlacer` object.
 */
+ (instancetype)placerWithCollectionView:(UICollectionView *)collectionView viewController:(UIViewController *)controller adPositioning:(CDAdPositioning *)positioning rendererConfigurations:(NSArray *)rendererConfigurations;
...
/**
 * The CDAds SDK adds interfaces to the `UICollectionView` class to help your application with
 * responsibilities related to `CDCollectionViewAdPlacer`. These APIs include methods to help notify
...
@interface UICollectionView (CDCollectionViewAdPlacer)

- (void)cd_setAdPlacer:(CDCollectionViewAdPlacer *)placer;
 ...
 */
- (CDCollectionViewAdPlacer *)cd_adPlacer;
 ...
 */
- (void)cd_setDataSource:(id<UICollectionViewDataSource>)dataSource;
 ...
 */
- (id<UICollectionViewDataSource>)cd_dataSource;
 ...
 */
- (void)cd_setDelegate:(id<UICollectionViewDelegate>)delegate;
 ...
 */
- (id<UICollectionViewDelegate>)cd_delegate;
 ...
 */
- (void)cd_insertItemsAtIndexPaths:(NSArray *)indexPaths;
 ...
 * `nil`.
 */
- (void)cd_deleteItemsAtIndexPaths:(NSArray *)indexPaths;
 ...
 */
- (void)cd_reloadItemsAtIndexPaths:(NSArray *)indexPaths;
 ...
 */
- (void)cd_moveItemAtIndexPath:(NSIndexPath *)indexPath toIndexPath:(NSIndexPath *)newIndexPath;
 ...
 */
- (void)cd_reloadSections:(NSIndexSet *)sections;
 ...
 */
- (UICollectionViewCell *)cd_cellForItemAtIndexPath:(NSIndexPath *)indexPath;
 ...
 * the index path to perform additional cdAdInfo based on the cell’s position in the collection
 * view.
 *
 * @return A valid `UICollectionReusableView` object.
 */
- (id)cd_dequeueReusableCellWithReuseIdentifier:(NSString *)identifier forIndexPath:(NSIndexPath*)indexPath;
 ...
 */
- (void)cd_deselectItemAtIndexPath:(NSIndexPath *)indexPath animated:(BOOL)animated;
 ...
 * collection view.
 */
- (NSIndexPath *)cd_indexPathForCell:(UICollectionViewCell *)cell;
 ...
 */
- (NSIndexPath *)cd_indexPathForItemAtPoint:(CGPoint)point;
 ...
 */
- (NSArray *)cd_indexPathsForSelectedItems;
 ...
 */
- (NSArray *)cd_indexPathsForVisibleItems;
 ...
 */
- (UICollectionViewLayoutAttributes *)cd_layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath;
 ...
 */
- (void)cd_scrollToItemAtIndexPath:(NSIndexPath *)indexPath atScrollPosition:(UICollectionViewScrollPosition)scrollPosition animated:(BOOL)animated;
 ...
 * finishes.
 */
- (void)cd_selectItemAtIndexPath:(NSIndexPath *)indexPath animated:(BOOL)animated scrollPosition:(UICollectionViewScrollPosition)scrollPosition;
...
@protocol CDCollectionViewAdPlacerDelegate <NSObject>
 ...
 */
-(void)nativeAdWillPresentModalForCollectionViewAdPlacer:(CDCollectionViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdDidDismissModalForCollectionViewAdPlacer:(CDCollectionViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdWillLeaveApplicationFromCollectionViewAdPlacer:(CDCollectionViewAdPlacer *)placer;
