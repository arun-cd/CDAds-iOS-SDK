...
@protocol CDStreamAdPlacerDelegate;
@protocol CDNativeAdRendering;
@class CDNativeAdRequestTargeting;
@class CDNativeAd;

/**
 * The `CDStreamAdPlacer` class allows you to retrieve native ads from the CDAds ad server and
 ...
 * `CDStreamAdPlacerDelegate` protocol to handle ad insertions.
 *
...
@interface CDStreamAdPlacer : NSObject
...
@property (nonatomic, weak) id<CDStreamAdPlacerDelegate> delegate;
@property (nonatomic, readonly, copy) CDAdPositioning *adPositioning;
 ...
 *
 */
+ (instancetype)placerWithViewController:(UIViewController *)controller adPositioning:(CDAdPositioning *)positioning rendererConfigurations:(NSArray *)rendererConfigurations;
...
@protocol CDStreamAdPlacerDelegate <NSObject>

@optional
- (void)adPlacer:(CDStreamAdPlacer *)adPlacer didLoadAdAtIndexPath:(NSIndexPath *)indexPath;
- (void)adPlacer:(CDStreamAdPlacer *)adPlacer didRemoveAdsAtIndexPaths:(NSArray *)indexPaths;
 ...
 */
- (void)nativeAdWillPresentModalForStreamAdPlacer:(CDStreamAdPlacer *)adPlacer;
 ...
 */
- (void)nativeAdDidDismissModalForStreamAdPlacer:(CDStreamAdPlacer *)adPlacer;
 ...
 */
- (void)nativeAdWillLeaveApplicationFromStreamAdPlacer:(CDStreamAdPlacer *)adPlacer;
